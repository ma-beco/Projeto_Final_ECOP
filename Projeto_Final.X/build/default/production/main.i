...
for (;;) {
    switch (muda) {
        case 0:
            ...
            tecla = kpRead();
            if (old != tecla) {
                if ((((tecla) & (1<<(0)))) && enter == 0) s1++;
                if ((((tecla) & (1<<(0)))) && enter == 1) s2++;
                if ((((tecla) & (1<<(0)))) && enter == 2) s3++;
                if (((tecla) & (1<<(6)))) {
                    enter++;
                    if (enter == 3) {
                        muda = 1;
        ...
        case 2:
            ...
            tecla = kpRead();
            if (old != tecla) {
                if (((tecla) & (1<<(1)))) moed += 100;
                if (((tecla) & (1<<(2)))) moed += 50;
                if (((tecla) & (1<<(3)))) moed += 25;
                if (((tecla) & (1<<(4)))) moed += 10;
                if (((tecla) & (1<<(5)))) moed += 5;
            }
            ssdInit();
            ssdDigit(((moed / 1000) % 10), 0);
            ssdDigit(((moed / 100) % 10), 1);
            ssdDigit(((moed / 10) % 10), 2);
            ssdDigit(((moed / 1) % 10), 3);
            ssdUpdate();
        ...
        case 3:
            ...
            tecla = kpRead();
            if (old != tecla) {
                if ((((tecla) & (1<<(0)))) && enter == 4) t1++;
                if ((((tecla) & (1<<(0)))) && enter == 5) t2++;
                if ((((tecla) & (1<<(0)))) && enter == 6) t3++;
                if (((tecla) & (1<<(6)))) {
                    enter++;
                    if (enter == 7 && t1 == s1 && t2 == s2 && t3 == s3) {
                        lcdPosition(0, 0);
